...
class modImportpurchaselines extends DolibarrModules
{
	...
	function __construct(DoliDB $db)
	{
		...
		$this->rights_class = 'importpurchaselines';
		...
		$this->config_page_url = array("admin.php@importpurchaselines");
		...
		$this->langfiles = array("importpurchaselines@importpurchaselines");
